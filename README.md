...
<p>EchoSearch is licensed under the [MIT License] (license.txt). This license grants full freedom to use, copy, modify, and distribute the software, with minimal restrictions. Users must include the original copyright and license notices in any redistributed or modified versions of the project.</p>
