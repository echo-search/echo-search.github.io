...
<p>But what you can do, is put it in a different repo and just include the credit. We are licensed under MIT (see the <a href="#license">License</a> for ease of usage worldwide.</p>
...
<p>EchoSearch is licensed under the MIT License. This license grants full freedom to use, copy, modify, and distribute the software, with minimal restrictions. Users must include the original copyright and license notices in any redistributed or modified versions of the project.</p>
